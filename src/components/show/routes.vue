<template>
	<div class="v-showbox">
		<div class="v-title">
			<h3>服务亭-打包站车辆轨迹 <a href="javascript:;" onclick="history.back()">关闭</a></h3>
		</div>
	...
	export default {
		...
		methods: {
			...
			getMap(){
				...
				// ======================================================== //
				//map地图画点
				let orderNum = that.$route.params.id //这个单号有数据30033481512695867208
				let type = that.$route.params.type //type 根据不同的type调用不同的接口
				if( ! orderNum || ! type) return
